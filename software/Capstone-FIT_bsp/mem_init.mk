...
MEM_0 := niosII_system_onchip_memory2
...
$(MEM_0)_START := 0x01904000
$(MEM_0)_END := 0x01907fff
...
# Memory: tristate_controller
MEM_2 := tristate_controller
$(MEM_2)_NAME := tristate_controller
...
$(MEM_2)_START := 0x01400000
$(MEM_2)_END := 0x017fffff
$(MEM_2)_HIERARCHICAL_PATH := tristate_controller
$(MEM_2)_WIDTH := 8
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: tristate_controller
tristate_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
